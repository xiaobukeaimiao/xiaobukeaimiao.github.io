...
我来自江西南昌, 出生于2008年9月28日, 中学就读于江科附中, 目前在清华大学求真书院学习数学.

数学方面, 我喜欢代数与几何方向. 正如单老师所说, 代数学其实就是不同领域之间的翻译. 连接不同领域的桥梁是我最喜欢的部分.

不学数学的时候, 我喜欢玩玩游戏, 以及出门去散步.

[Bilibili](https://space.bilibili.com/588752996) · [QQ](https://user.qzone.qq.com/3568085446) · [GitHub](https://github.com/xiaobukeaimiao)

> **Disclaimer:** The materials here are for personal study and reference only. Commercial use or unauthorized distribution is strictly prohibited.
...
> **Disclaimer:** These personal notes are unofficial and have not been reviewed or endorsed by the course instructors.
...
[In Wonderment of Winter - Ori and the Will of the Wisps](https://huggingface.co/datasets/xiaobukeai/personal_mainpage/resolve/main/files/music/In_Wonderment_of_Winter.flac)

[City of Tears - Hollow Knight](https://huggingface.co/datasets/xiaobukeai/personal_mainpage/resolve/main/files/music/City_of_Tears.flac)

[遺サレタ場所_斜光 - NieR: Automata](https://huggingface.co/datasets/xiaobukeai/personal_mainpage/resolve/main/files/music/遺サレタ場所_斜光.flac)

[Fleatopia - Silksong](https://huggingface.co/datasets/xiaobukeai/personal_mainpage/resolve/main/files/music/Fleatopia.flac)

[Frostbounce - Strawberry Jam](https://huggingface.co/datasets/xiaobukeai/personal_mainpage/resolve/main/files/music/Frostbounce.flac)

[星茶会 - 灰澈](https://huggingface.co/datasets/xiaobukeai/personal_mainpage/resolve/main/files/music/星茶会.flac)

[Ode to the Bridge Builder - World of Goo](https://huggingface.co/datasets/xiaobukeai/personal_mainpage/resolve/main/files/music/Ode_to_the_Bridge_Builder.flac)
